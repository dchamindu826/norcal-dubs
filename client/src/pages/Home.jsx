    ...
    <div className="bg-[#050505] min-h-screen text-white pb-20 overflow-x-hidden">
      ...
      <div className="container mx-auto px-6 mb-20">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 border-b border-white/10 pb-6 gap-6">
          ...
          {/* මෙතන ලින්ක් එක collection වලට හැදුවා */}
          <Link to="/collection" className="flex items-center gap-2 text-xs font-bold bg-[#39FF14] text-black px-6 py-3 rounded-full hover:bg-white transition-all uppercase tracking-widest hover:scale-105 shadow-[0_0_15px_rgba(57,255,20,0.3)]">
