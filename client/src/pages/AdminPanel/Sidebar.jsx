  ...
  return (
    <div className="w-64 h-screen bg-[#050505] border-r border-white/10 flex flex-col p-4 fixed left-0 top-0 overflow-y-auto">
      ...
      <div className="flex items-center gap-3 mb-10 px-2">
        <img src="/logo-nobg.png" alt="Logo" className="w-8 h-8 object-contain" />
        <h1 className="text-white font-bold tracking-widest text-xs uppercase leading-tight">
          NORCAL BUDZ <br/><span className="text-[#39FF14] text-sm">ADMIN</span>
        </h1>
      </div>
